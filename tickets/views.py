...
def event_detail(request, event_id):
    ...
    return render(request, 'tickets/event_detail.html',
                  {'event': event, 'formatted_date': formatted_date, 'formatted_time': formatted_time})
...
def event_organisation_events(request, event_id, organisation_name):
    ...
    return render(request, 'tickets/event_organisation_event.html',
                  {'organisation': organisation, 'events': events, 'current_event': current_event})
...
def organisation_admin_page(request, organisation_name):
    if not request.user.is_authenticated:
        return render(request, 'tickets/organisation_events.html', {
    ...
    if request.user.username == organisation_name:
        ...
        return render(request, 'tickets/organisation_admin_page.html', {'organisation': organisation})
    else:
        return render(request, 'tickets/organisation_admin_page.html',
...
def delete_event(request, organisation_name, event_id):
    ...
    if request.method == 'POST':
        event.delete()
    return render(request, 'tickets/organisation_event_delete.html',
                  {'organisation_name': organisation_name, 'event': event})
...
def organisation_event_detail(request, organisation_name, event_id):
    ...
    return render(request, 'tickets/organisation_event_detail.html',
                  {'event': event, 'organisation': organisation, 'formatted_date': formatted_date,
...
def contact(request):
    ...
    return render(request, 'tickets/organisation_events_detail.html',
                  {'message': "Accès non autorisé à cette organisation."})
